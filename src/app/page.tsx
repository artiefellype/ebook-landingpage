    ...
    <main className="flex flex-col w-screen">
      <section className="flex flex-row w-screen text-defaultText1 justify-center items-center max-w-[1990px]">
        ...
        >
          ...
          <a  href="https://pay.hotmart.com/L82747605D?checkoutMode=10" className=" w-[296px] sm:w-[374px] h-[57px] sm:h-[70px] bg-defaultBg sm:bg-defaultText2 text-defaultText1 sm:my-0 my-4 flex items-center justify-center font-raleway font-extrabold text-base sm:text-xl sm:text-defaultBg leading-[108%] shadow-defaultBox hover:bg-orange-800 transition-all ease-in-out delay-100">
            <span className=" flex w-[190px] sm:h-[44px] text-center">
              Garantir Minha Transformação
            </span>
          </a>

          <a href="#more" className="flex sm:hidden font-raleway text-center justify-center items-center sm:text-left font-extrabold text-xl sm:text-2xl w-[205px] sm:w-[546px] sm:my-0 my-4 text-defaultBg">
            <span>SABER MAIS</span>
          </a>
          <div className="sm:hidden inline z-[-1] overflow-x-hidden absolute w-screen bottom-0 left-0">
          <img src="/wave 1.svg" alt="" width={1440} height={388} />
        ...
        <div className=" flex flex-col xl:flex-row max-w-[1990px] w-full py-36 bg-defaultText1 text-defaultBg justify-center items-center">
          ...
          <div className="flex flex-col w-full">
            ...
            <div className=" w-full flex flex-col items-center gap-8 justify-end font-raleway font-semibold ">
              ...
              <a  href="https://pay.hotmart.com/L82747605D?checkoutMode=10" className="w-[236px] h-[42px] bg-defaultText2 flex items-center justify-center font-raleway font-extrabold text-xl text-defaultBg leading-[108%] shadow-defaultBox hover:bg-orange-800 transition-all ease-in-out delay-100">
